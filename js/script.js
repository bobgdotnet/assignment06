// I got it down to one line by using a "," 
window.onload = () => empForm.onsubmit = e => (e.preventDefault(), [...e.target.elements].forEach(element => element.id && console.log(`${element.id}: ${element.value}`)));
